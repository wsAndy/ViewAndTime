...
//    Mat img2_col = imread( path + "cam2/color-cam2-f000.jpg");
        ...
        Mat img_object = imread( path + "cam0/color-cam0-f000.jpg",CV_32FC3);
        Mat img_scene = imread( path + "cam2/color-cam2-f000.jpg", CV_32FC3);

        int row = img_object.rows;
        int col = img_object.cols;

        resize(img_object, img_object,Size(int(col/2),int(row/2)));
        resize(img_scene, img_scene,Size(int(col/2),int(row/2)));
        ...
        cout << offset <<endl;
        line(img_matches, scene_corners[0] + offset, scene_corners[1] + offset, Scalar(255, 0, 0), 4);
        line(img_matches, scene_corners[1] + offset, scene_corners[2] + offset, Scalar(0, 255, 0), 4);
        line(img_matches, scene_corners[2] + offset, scene_corners[3] + offset, Scalar(0, 0, 255), 4);
        line(img_matches, scene_corners[3] + offset, scene_corners[0] + offset, Scalar(0, 0, 0), 4);
